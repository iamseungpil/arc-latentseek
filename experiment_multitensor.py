#!/usr/bin/env python3
"""
MultiTensor Loss-based LatentSeek Experiment
Uses multiple evaluation metrics for optimization
"""
...
from src.optimizers.latent_optimizer_multitensor_v6 import MultiTensorOptimizerV6

# Setup logging
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

def run_multitensor_experiment(
    num_problems: int = 10,
    device: str = "cuda",
    model_name: str = "barc0/Llama-3.1-ARC-Potpourri-Induction-8B",
    output_dir: str = "results/multitensor"
):
    """Run MultiTensor-based LatentSeek experiment"""
    ...
    # Initialize optimizer with gradient-flow fixed approach
    optimizer = MultiTensorOptimizerV6(
    ...
    # Results tracking
    results = {
        "experiment": "multitensor_latentseek",
        "model": model_name,
