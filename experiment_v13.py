#!/usr/bin/env python3
"""
Experiment with V13 - Proper multi-line description finding
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('experiment_v13.log')
    ]
)
...
def run_v13_experiment(
    ...
    """Run V13 experiment with proper description finding."""
    ...
    # Results storage
    results = {
        "experiment": "v13_proper_description",
    ...
    for i, problem_id in enumerate(problem_ids):
        ...
        logger.info(f"Initial code length: {len(initial_code)} chars")
        logger.info(f"Initial description: {initial_result.get('description', 'N/A')[:100]}...")
        ...
        if opt_result["success"]:
            ...
            # Save final code
            code_path = Path(f"results/v13/{problem_id}_final.py")
        ...
        with open("results/v13/results.json", 'w') as f:
    ...
    if completed:
        ...
        logger.info(f"Results saved to: results/v13")
        logger.info(f"{'='*80}")
...
if __name__ == "__main__":
    ...
    run_v13_experiment(device="cuda:0")