#!/usr/bin/env python3
"""
Simple V10 Experiment
Based on original LatentSeek approach
"""
...
from src.optimizers.latent_optimizer_simple_v10 import SimpleLatentOptimizerV10

# Setup logging
logging.basicConfig(level=logging.INFO)
logger = logging.getLogger(__name__)

def run_simple_v10_experiment(
    num_problems: int = 10,
    device: str = "cuda",
    model_name: str = "barc0/Llama-3.1-ARC-Potpourri-Induction-8B",
    output_dir: str = "results/simple_v10"
):
    """Run Simple V10 experiment"""
    ...
    # Initialize V10 optimizer
    optimizer = SimpleLatentOptimizerV10(
        ...
        k=0.2,  # Update 20% like LatentSeek
    ...
    for i, problem in enumerate(problems):
        ...
        try:
            ...
            # Run V10 optimization
            logger.info("\nRunning Simple V10 optimization...")
    ...
    logger.info(f"\n{'='*80}")
    logger.info("V10 EXPERIMENT COMPLETE")
