...
if __name__ == "__main__":
    print(f"Starting GPU5 experiment - output dir: comparative_results_gpu5_20250723_042519")
    print(f"CUDA_VISIBLE_DEVICES = {os.environ.get('CUDA_VISIBLE_DEVICES')}")
    
    experiment = ComparativeExperimentV2(output_dir="comparative_results_gpu5_20250723_042519")
